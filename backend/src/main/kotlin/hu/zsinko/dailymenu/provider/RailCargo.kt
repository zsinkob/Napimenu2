...
@Service
class RailCargo(private val facebookService: FacebookService) : MenuProvider {

    private val restaurant = Restaurant("Rail Cargo", "https://www.facebook.com/Átrium-Étterem-220584624687096/")
